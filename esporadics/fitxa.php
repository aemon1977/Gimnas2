...
// Conexiï¿½ï¿½n a la base de datos
...
// Buscar socio si se envï¿½ï¿½a el formulario de bÇ§squeda
if (isset($_POST['buscar'])) {
    ...
    if ($result_buscar->num_rows > 0) {
        ...
        echo "No s'han trobat esporàdics.";
    }
}

// Obtener todos los socios para mostrar en la tabla
$sql_todos_socios = "SELECT DNI, Nom FROM esporadics";
...
<head>
    <meta charset="UTF-8">
    <title>Fitxa d'espor&agrave;dics</title>
...
<div class="page">
    <div class="card">
        <h1>Fitxa d'espor&agrave;dics</h1>
    ...
    <div class="table-card">
        <table>
            ...
            <tbody>
                <?php if ($result_todos_socios->num_rows > 0): ?>
                    <?php while ($socio = $result_todos_socios->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td>
                                <a href="ver_ficha.php?DNI=<?php echo $socio['DNI']; ?>">
                                    <?php echo $socio['Nom']; ?>
                                </a>
                            </td>
                        </tr>
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="2">No hi ha espor&agrave;dics disponibles.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
